...
/** Send an immediate local notification when a habit is completed.
 *  @param habitName  Display name of the habit
 *  @param habitEmoji Emoji of the habit
 */
export async function sendCompletionNotification(
  ...
  await Notifications.scheduleNotificationAsync({
    content: {
      title: `${habitEmoji} ¡Hábito completado!`,
      body:  `¡Completaste "${habitName}" hoy! Sigue así 💪`,
    },
    trigger: null,
  });
}
